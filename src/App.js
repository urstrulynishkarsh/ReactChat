...
function App() {
  ...
  return (
    <div className={`w-screen h-[100vh] ${darkMode ? 'bg-black' : ''}  bg-[#ededed] flex justify-end items-center flex-col font-inter`}>
    ...
    <button className=" darkmode flex justify-end absolute xl:top-2 xl:right-48 top-16 right-5 sm:top-2 sm:right-48 md:top-2 md:right-48  lg:top-2 lg:right-48 z-40  " onClick={hanldeDarkMode}>
