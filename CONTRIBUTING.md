...
Welcome to [ReactChat](https://github.com/urstrulynishkarsh/ReactChat). Before sending your pull requests, make sure that you **read the whole
...
**1.** Fork [this](https://github.com/urstrulynishkarsh/ReactChat/) repository.

**2.** Clone the forked repository.

```bash
git clone https://github.com/your_username/ReactChat
```
...
**8.** Create a [PR](https://github.com/urstrulynishkarsh/ReactChat) to `develop` !) repository.

### 🔑Guidelines

Here are some set of guidelines to follow while contributing to `ReactChat` :
